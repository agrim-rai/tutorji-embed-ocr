    ...
    const messages = [
      {
        ...
        content: [
          {
            type: "text",
            text: "Compare these two images and determine if they are the same or very similar. Look at the content, text, layout, and overall appearance. Respond with a JSON object containing: { \"areSame\": boolean, \"confidence\": number (0-1), \"explanation\": \"detailed explanation of your comparison\" }"
          },
          {
            type: "image_url",
            image_url: {
