      ...
      if (expr.type === 'display') {
        ...
        parts.push(
          <span
            ...
            className="inline-math overflow-x-auto overflow-y-hidden whitespace-nowrap inline-block max-w-full"
          >
  ...
  return (
    <div className={`simple-math-renderer ${className}`}>
      ...
      <style jsx global>{`
        ...
        /* Ensure elements that use overflow-x-auto never show vertical scrollbars */
        .simple-math-renderer .overflow-x-auto {
          overflow-y: hidden;
        }
      `}</style>
    </div>
